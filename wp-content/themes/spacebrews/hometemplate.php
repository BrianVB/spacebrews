...
#universe.opening #home {
  box-shadow: 0 0 0 rgba(255, 160, 60, 0); }

/* --------------------------------------------------------------------------- 2D view */
.view-2D.zoom-large #home {
...
.scale-stretched #About .planet {
  font-size: 2.9em; }

.scale-stretched #spacebrews .planet {
  font-size: 12em; }

.scale-stretched #blog .planet {
  font-size: 10.8em; }

.scale-stretched #store .planet {
  font-size: 4.68em; }

.scale-stretched #contact .planet {
  font-size: 4.9em; }
...
.scale-stretched #About.orbit {
  width: 72em;
  height: 72em;
  margin-top: -36em;
  margin-left: -36em; }

.scale-stretched #spacebrews.orbit {
  width: 100em;
  height: 100em;
  margin-top: -50em;
  margin-left: -50em; }

.scale-stretched #blog.orbit {
  width: 150em;
  height: 150em;
  margin-top: -75em;
  margin-left: -75em; }

.scale-stretched #store.orbit {
  width: 186em;
  height: 186em;
  margin-top: -93em;
  margin-left: -93em; }

.scale-stretched #contact.orbit {
  width: 210em;
  height: 210em;
  margin-top: -105em;
  margin-left: -105em; }
...
#About .planet {
  animation-name: shadow-About;
  -webkit-animation-name: shadow-About; }

@keyframes shadow-About {
  0% {
...
.scaled.view-2D #About .planet,
.scaled.view-3D #About .planet {
  box-shadow: inset -4px 0 2px rgba(0, 0, 0, 0.5);
  /* RIGHT */ }

/* --------------------------------------------------------------------------- The Spacebrews ; pos: Right */
#spacebrews .pos {
  left: 100%;
  top: 50%; }

#spacebrews .planet {
  animation-name: shadow-spacebrews;
  -webkit-animation-name: shadow-spacebrews; }

@keyframes shadow-spacebrews {
  0% {
...
@-webkit-keyframes shadow-spacebrews {
  0% {
    box-shadow: inset -16px 0 5px rgba(0, 0, 0, 0.5);
    /* RIGHT */ }
...
.scaled.view-2D #spacebrews .planet,
.scaled.view-3D #spacebrews .planet {
  box-shadow: inset -16px 0 5px rgba(0, 0, 0, 0.5);
  /* RIGHT */ }
...
#blog .planet {
  animation-name: shadow-blog;
  -webkit-animation-name: shadow-blog; }

@keyframes shadow-blog {
  0% {
    box-shadow: inset 16px 0 5px rgba(0, 0, 0, 0.5);
    /* LEFT */ }
...
.scaled.view-2D #blog .planet,
.scaled.view-3D #blog .planet {
  box-shadow: inset -16px 0 5px rgba(0, 0, 0, 0.5);
  /* RIGHT */ }

/* --------------------------------------------------------------------------- blog ring */

#blog .ring           { animation-name:     shadow-blog-ring;
                        -webkit-animation-name: shadow-blog-ring; }

@keyframes 
shadow-blog-ring{ 0%   { box-shadow: inset -16px  0      4px   rgba(20, 40, 50, 0.45); opacity: .4; }
...
.scaled.view-2D #blog .ring,
.scaled.view-3D #blog .ring { box-shadow: inset 16px   0      4px   rgba(20, 40, 50, 0.6); }
...
#store .planet {
  animation-name: shadow-store;
  -webkit-animation-name: shadow-store; }

@keyframes shadow-store {
  0% {
...
.scaled.view-2D #store .planet,
.scaled.view-3D #store .planet {
  box-shadow: inset -8px 0 5px rgba(0, 0, 0, 0.5);
  /* RIGHT */ }
...
#contact .planet {
  animation-name: shadow-contact;
  -webkit-animation-name: shadow-contact; }

@keyframes shadow-contact {
  0% {
    box-shadow: inset 0 0 2px rgba(0, 0, 0, 0.5);
    /* TOP */ }
...
@-webkit-keyframes shadow-contact {
  0% {
    box-shadow: inset 0 0 2px rgba(0, 0, 0, 0.5);
    /* TOP */ }
  ...
  100% {
    box-shadow: inset 0 0 2px rgba(0, 0, 0, 0.5);
    /* TOP */ } }
.scaled.view-2D #contact .planet,
.scaled.view-3D #contact .planet {
  box-shadow: inset -12px 0 5px rgba(0, 0, 0, 0.5);
  /* RIGHT */ }
...
.earth #earth.orbit,
.About #About.orbit,
.spacebrews #spacebrews.orbit,
.blog #blog.orbit,
.store #store.orbit,
.contact #contact.orbit {
...
.ring {
  ...
  -webkit-transition-property: width, height, top, left, margin-left, margin-top, webkit-transform; }
